      ...
      <div className="lg:flex gap-12 items-center w-[85%] mx-auto">
        ...
        <div className="lg:flex-1 mt-8 lg:mt-0 space-y-6 text-center lg:text-left">
          ...
          <p className="text-gray-300 leading-relaxed">
            I’m <span className="font-semibold text-white">Kayode</span>, a passionate 
            <span className="text-red-500 font-semibold"> Frontend Developer</span> who loves crafting 
          ...
          <button className="mt-4 bg-red-500 text-white px-6 py-3 rounded-md font-semibold shadow hover:bg-red-600 transition">
            Get In Touch
          </button>
        </div>
      </div>
